...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 22:22:22 2019
...
#        target_dlamda = wl * (ex_lambda - gt_lambda)
        targets_dlamda = wl * (p + 45)/135
        
#        targets_dlamda = wl * gt_lambda

        targets = torch.stack((targets_dx, targets_dy, targets_dw, targets_dh), dim=1)
        targets_angle = targets_dlamda
        return targets, targets_angle
    
   

    def decode(self, rel_codes, lambda_, boxes):
        """
...
#        pred_alpha = pred_h/pred_w
        ...
        pred_theta = dl * 135 - 45 + pred_alpha
#        pred_theta = dl * 90 
