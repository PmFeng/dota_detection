...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 10:25:16 2019
...
#matched_targets.bbox, proposals_per_image.bbox, gt_theta
    ...
    def encode(self, reference_boxes, proposals, gt_theta):
        ...
        #ex_lambda = kornia.rad2deg(torch.atan(ex_heights/ex_widths)) / 90
...
#        gt_lambda = ex_lambda/gt_theta
        gt_lambda_ratio = gt_theta / kornia.rad2deg(torch.atan(gt_heights/gt_widths))
        ...
        ex_lambda = wl * ex_lambda

        targets = torch.stack((targets_dx, 
                               targets_dy, 
                               targets_dw, 
                               targets_dh, 
                               targets_dlamda, 
                               gt_lambda_ratio), dim=1)
