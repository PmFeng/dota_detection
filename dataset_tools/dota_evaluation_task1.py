...
#    imagenames = [x.strip() for x in lines]
    ...
    for imagename in imagenames:
        pred_bbox = pred_boxlist[imagename].bbox.numpy()
        pred_label = pred_boxlist[imagename].get_field("labels").numpy()
        pred_score = pred_boxlist[imagename].get_field("scores").numpy()
        gt_bbox = gt_boxlists[imagename].bbox.numpy()
        gt_label = gt_boxlists[imagename].get_field("labels").numpy()
        gt_difficult = gt_boxlists[imagename].get_field("difficult").numpy()
        R = [obj for obj in gt_label if obj == classname]
        bbox = gt_bbox
        difficult = gt_difficult.astype(np.bool)
        det = [False] * len(R)
